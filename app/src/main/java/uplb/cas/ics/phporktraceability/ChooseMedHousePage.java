 ...
 */
public class ChooseMedHousePage extends AppCompatActivity implements View.OnDragListener
{
    ...
    private static final String LOGCAT = ChooseMedHousePage.class.getSimpleName();
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomPagerAdapter(ChooseMedHousePage.this, lists, lists2, lists3, ids);
