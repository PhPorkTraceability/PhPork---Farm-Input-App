 ...
 */
public class LastMedicationGivenEdit extends AppCompatActivity
    ...
    private static final String LOGCAT = LastMedicationGivenEdit.class.getSimpleName();
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomPagerAdapter(LastMedicationGivenEdit.this, lists1, lists2, lists3, ids);
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent i = new Intent(LastMedicationGivenEdit.this, LastFeedGivenPage.class);
        i.putExtra("rfid", rfid);
        i.putExtra("boar_id", boar_id);
        i.putExtra("sow_id", sow_id);
        i.putExtra("foster_sow", foster_sow);
