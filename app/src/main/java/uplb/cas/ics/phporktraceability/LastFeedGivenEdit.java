 ...
 */
public class LastFeedGivenEdit extends AppCompatActivity
    ...
    private static final String LOGCAT = LastFeedGivenEdit.class.getSimpleName();
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomPagerAdapter(LastFeedGivenEdit.this, lists1, lists2, lists3, ids);
